...
5. 通常: active layer色の全灯／4灯パターンまたは虹色サイクル + 選択された打鍵アニメーション

PCのresume後は現在Layerの表示へ戻ります。Layer表示は全灯、4灯で8 Layerを識別するパターン、4灯を流れる虹色サイクルから選択できます。Layer色とpixelごとの点灯状態は200 ms以内で遷移します。打鍵アニメーションは無効／波紋／フラッシュ／スパーク／打鍵虹色から選択します。波紋／フラッシュ／スパークは現在または切り替え後のLayer色を使い、打鍵虹色は4灯へ異なる虹色を重ねます。
